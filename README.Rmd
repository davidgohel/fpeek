...
[![test coverage](https://codecov.io/gh/davidgohel/fpeek/branch/master/graph/badge.svg)](https://app.codecov.io/gh/davidgohel/fpeek)
...
* Function `peek_guess_delim()` detects the delimiter, quote character and
decimal mark of a delimited text file.
...
```{r 'file-iconv-sink-ex', results='hide'}
file_utf8 <- tempfile()
