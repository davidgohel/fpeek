...
[![fpeek
logo](reference/figures/logo.png)](https://github.com/davidgohel/fpeek)
...
- Use function
  [`peek_count_lines()`](https://davidgohel.github.io/fpeek/dev/reference/peek_count_lines.md)
  to count lines contained in a file.
- Functions
  [`peek_head()`](https://davidgohel.github.io/fpeek/dev/reference/peek_head.md)
  and
  [`peek_tail()`](https://davidgohel.github.io/fpeek/dev/reference/peek_tail.md)
  will display first and last lines of the file.
- Function
  [`peek_guess_delim()`](https://davidgohel.github.io/fpeek/dev/reference/peek_guess_delim.md)
  detects the delimiter, quote character and decimal mark of a delimited
  text file.
- Function
  [`peek_guess_encoding()`](https://davidgohel.github.io/fpeek/dev/reference/peek_guess_encoding.md)
...
Function
[`peek_iconv()`](https://davidgohel.github.io/fpeek/dev/reference/peek_iconv.md)
is converting the content of the file and print the result in the
console. Use `peek_iconv(newfile = "...")` to create a new reencoded
file:
...
[`peek_guess_delim()`](https://davidgohel.github.io/fpeek/dev/reference/peek_guess_delim.md)
reads the first lines of a text file and detects the delimiter, quote
...
[`peek_guess_encoding()`](https://davidgohel.github.io/fpeek/dev/reference/peek_guess_encoding.md)
detects the encoding of a text file. It requires the `readr` package
(listed in Suggests).
